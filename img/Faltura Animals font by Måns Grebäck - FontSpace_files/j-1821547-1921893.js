...
(function(){
    ...
    (function() {
    var p = "1821547", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_1821547||'',
    GUID:window.ftGUID_1821547||'99999999999',
    confID:window.ftConfID_1821547||'0',
    ftReturn: window.ftReturn_1821547||'',
    keyword:window.ftKeyword_1821547||'',
    ftId:window.ftId_1821547||'',
    imp:window.ftImp1821547,
    ftImpId:window.ftImp1821547 && window.ftImp1821547.impID || '',
    campaignID:'58119',
    cID:'75749',
    pID:'1821547',
    creativeID:'1921893',
    exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.GDN.ENTFAN&cvo_creative=CDA_wklyOrange_170712_728x090.zip&cvo_pid=SLNGD_USA_ENTFAN_DT_DIS_GDN_PPR_GAMEOFTHRO_ROTATED_XXXXXX_728x090"],
    extscript:["https://z.moatads.com/keplerslingtvflashtalking517548650154/moatad.js#moatClientLevel1=58119&moatClientLevel2=5056&moatClientLevel3=1821547&moatClientLevel4=1921893[noCachebuster]"],
    clickTags: ["http://servedby.flashtalking.com/click/8/58119;1821547;1921893;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/watch-hbo?cvosrc=Display.GDN.ENTFAN&cvo_creative=CDA_wklyOrange_170712_728x090.zip&cvo_pid=SLNGD_USA_ENTFAN_DT_DIS_GDN_PPR_GAMEOFTHRO_ROTATED_XXXXXX_728x090&utm_source=rtbprospecting&utm_medium=display&utm_campaign=ROTATED"],
    placementDescription:'SLNGDUSAENTFANDTDISGDNPPRGAMEOFTHROROTATEDXXXXXX728x090',
    width:728,
    height:90,
    ...
    divID:'ftdiv1821547',
    phID:'ftpos1821547',
    frameID:'ftframe1821547',
    expID:'ftexpframe1821547',
    altImgID:'ftalt1821547',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/58119;1821547;1921893;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/watch-hbo?cvosrc=Display.GDN.ENTFAN&cvo_creative=CDA_wklyOrange_170712_728x090.zip&cvo_pid=SLNGD_USA_ENTFAN_DT_DIS_GDN_PPR_GAMEOFTHRO_ROTATED_XXXXXX_728x090&utm_source=rtbprospecting&utm_medium=display&utm_campaign=ROTATED',
    altImg:'http://servedby.flashtalking.com/imp/8/58119;1821547;204;gif;GoogleDisplayNetwork;SLNGDUSAENTFANDTDISGDNPPRGAMEOFTHROROTATEDXXXXXX728x090/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/58119;1821547;271;pixel;GoogleDisplayNetwork;SLNGDUSAENTFANDTDISGDNPPRGAMEOFTHROROTATEDXXXXXX728x090/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/58119;1821547;207;guid;GoogleDisplayNetwork;SLNGDUSAENTFANDTDISGDNPPRGAMEOFTHROROTATEDXXXXXX728x090/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/182/1821547/1921893/js/j-1821547-1921893.js',
    file:'http://cdn.flashtalking.com/75749/1921893/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?94132217-1821547;1921893;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_1821547||'',
    segmentList:window.ftSegmentList_1821547||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp1821547 && window.ftImp1821547.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m1821547')&&/^https:/.test(document.getElementById('ftscript_m1821547').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m1821547'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_1821547'],
        ['ftcfid', 'ftConfID_1821547'],
        ['fttime', 'ftTimestamp_1821547'],
        ['ftsection', 'ftSection_1821547'],
        ['ftcustom', 'ftCustom_1821547'],
        ['ft_id', 'ftId_1821547'],
        ['ftimpid','ftImp1821547', 'impID']
    ]
};
